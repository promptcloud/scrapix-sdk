...
------------ | ------------- | ------------- | -------------
**id** | **UUID** | Unique identifier for the scraping task | [optional] 
**url** | **str** | Input URL | 
...
**auto_proxy** | **bool** | Use auto proxy: normal proxies (2 attempts) → premium proxies → render fallback | [optional] [default to False]
